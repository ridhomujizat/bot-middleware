...
func (a *BotpressService) Login(botAccount, tenantId string, refreshToken *bool) (*LoginRespon, error) {
	...
	if diffDays >= 1 || account.Token == "" || *refreshToken {
		...
		if err != nil {
			return nil, util.HandleAppError(err, "Botpress Login", "JSON Marshal", false)
		}
		...
		if errDecode != nil {
			return nil, util.HandleAppError(err, "Botpress Login", "JSON Unmarshal", false)
		}
...
func (a *BotpressService) AskBotpress(uniqueId string, token string, baseURL string, botP *AskPayloadBotpresDTO, RefreshToken *RefreshToken) (*BotpressRespon, error) {
	...
	if err != nil {
		return nil, util.HandleAppError(err, "AskBotpress", "JSON Marshal", false)
	}
	...
	if err != nil {
		return nil, util.HandleAppError(err, "AskBotpress", "JSON Unmarshal", false)
	}
